...
Revision ID: 8bdb50bff9a4
Revises: 8959aaa7a641
Create Date: 2024-06-25 14:05:37.279380
...
revision: str = '8bdb50bff9a4'
down_revision: Union[str, None] = '8959aaa7a641'
...
def downgrade() -> None:
    ...
    sa.Column('storage_provider_id', sa.CHAR(length=32), nullable=True),
    sa.Column('storage_object_id', sa.CHAR(length=32), nullable=True),
    sa.Column('vector_db_provider_id', sa.CHAR(length=32), nullable=True),
    sa.Column('processing_enabled', sa.BOOLEAN(), nullable=False),
    sa.Column('pre_processing_id', sa.CHAR(length=32), nullable=True),
    sa.Column('post_processing_id', sa.CHAR(length=32), nullable=True),
    ...
    sa.Column('processing_id', sa.CHAR(length=32), nullable=False),
    sa.Column('user_id', sa.CHAR(length=32), nullable=False),
    sa.Column('processing_type', sa.VARCHAR(), nullable=False),
    sa.Column('template', sa.VARCHAR(), nullable=True),
    sa.Column('pii_masking', sa.VARCHAR(), nullable=True),
    sa.Column('normalization', sa.VARCHAR(), nullable=True),
    sa.Column('stopword_removal', sa.VARCHAR(), nullable=True),
    sa.Column('is_deleted', sa.BOOLEAN(), nullable=False),
    sa.Column('creator_id', sa.CHAR(length=32), nullable=False),
    sa.Column('created_at', sa.DATETIME(), nullable=False),
    sa.Column('updater_id', sa.CHAR(length=32), nullable=True),
