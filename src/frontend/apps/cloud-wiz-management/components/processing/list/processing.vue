  ...
  data() {  
    return {  
      tab: [  
        ...
        { type: 'pre', name: 'PRE', active: false, icon: 'chevrons-left', id: 'top-pre', label: 'pre-tab' },  
        { type: 'post', name: 'POST', active: false, icon: 'chevrons-right', id: 'top-post', label: 'post-tab' }  
      ],  
      loading: false,  
